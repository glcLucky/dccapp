...
def main(args):
    ...
    return pretrain(args, outputdir, {'nlayers':4, 'dropout':0.2, 'reluslope':0.0,
                       'nepoch':nepoch, 'lrate':[args.lr], 'wdecay':[0.0], 'step':step}, use_cuda, trainloader, logger)

def pretrain(args, outputdir, params, use_cuda, trainloader, logger):
